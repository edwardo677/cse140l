...
#endif
static const char *ng0 = "%d %d %d %d | %d";
static const char *ng1 = "/home/kyly/GDrive/wi15/CSE140l/EdwardLab1/EncoderTest.v";
static int ng2[] = {0, 0};
static int ng3[] = {1, 0};

void Monitor_82_2(char *);
void Monitor_86_4(char *);
void Monitor_82_2(char *);
void Monitor_86_4(char *);


static void Monitor_82_2_Func(char *t0)
{
    char *t1;
    char *t2;
    char *t3;
...
static void Monitor_86_4_Func(char *t0)
{
    char *t1;
    char *t2;
    char *t3;
...
LAB2:    xsi_set_current_line(82, ng1);
    Monitor_82_2(t0);
...
LAB0:    t1 = (t0 + 3552);
    t2 = (t0 + 4312);
    xsi_vlogfile_monitor((void *)Monitor_82_2_Func, t1, t2);

LAB1:    return;
}

void Monitor_86_4(char *t0)
{
    char *t1;
    char *t2;
...
LAB0:    t1 = (t0 + 3800);
    t2 = (t0 + 4328);
    xsi_vlogfile_monitor((void *)Monitor_86_4_Func, t1, t2);

LAB1:    return;
}


extern void work_m_14494976880666626698_3673047746_init()
{
	static char *pe[] = {(void *)Initial_47_0,(void *)Initial_81_1,(void *)Initial_85_3,(void *)Monitor_82_2,(void *)Monitor_86_4};
	xsi_register_didat("work_m_14494976880666626698_3673047746", "isim/EncoderTest_isim_beh.exe.sim/work/m_14494976880666626698_3673047746.didat");
